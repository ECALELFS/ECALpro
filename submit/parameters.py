...
inputlist_n      = 'InputList/AlCaP0_2016H_06Jan2017_purified_run284029.list'
dirname          = 'seedStudy_run284029_LS39to111_v1'
Silent           = False                 # True->Fill modules is silent; False->Fill modules has a standard output
#TAG, QUEUE and ITERS
NameTag          = 'seedStudy_run284029_LS39to111_v1_'                   # Tag to the names to avoid overlap
...
# NOTE: leave a pace at the end! It is needed to search a seed name in the string without ambiguity 
...
json_file          = 'Cert_284029_LS39to111_JSON.txt' if isMC==False else ''            #/afs/cern.ch/cms/CAF/CMSALCA/ALCA_ECALCALIB/json_ecalonly/
