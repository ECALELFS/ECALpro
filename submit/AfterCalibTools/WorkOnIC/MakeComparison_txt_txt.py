...
for nXtal in range(len(file1_v)):
    ...
    if(nXtal<61200):
       ...
       #print 'EE: ' + str(nXtal-61200) + ': ' + str(IC_EE_1[nXtal-61200][0]) + ' ' + str(IC_EE_1[nXtal-61200][1]) + ' ' + str(IC_EE_1[nXtal-61200][2]) + ' ' + str(IC_EE_1[nXtal-61200][3])
#Out Put
f = TFile(str(sys.argv[3]), 'recreate')
...
for find_EE1 in range(len(IC_EE_1)):
    ...
    for find_EE2 in range(len(IC_EE_2)):
        if(IC_EE_1[find_EE1][0]==IC_EE_2[find_EE2][0] and IC_EE_1[find_EE1][1]==IC_EE_2[find_EE2][1] and IC_EE_1[find_EE1][2]==IC_EE_2[find_EE2][2]):
           #print 'iX: ' + str(IC_EE_1[find_EE1][0]) + ', iY = ' + str(IC_EE_1[find_EE1][1]) + ', iZ: ' + str(IC_EE_1[find_EE1][2]) + ' | iX: ' + str(IC_EE_2[find_EE2][0]) + ', iY = ' + str(IC_EE_2[find_EE2][1])+ ', iZ: ' + str(IC_EE_2[find_EE2][2])
           ...
           if(float(IC_EE_1[find_EE1][3])!=-1. and float(IC_EE_2[find_EE2][3])!=-1. ):
              ...
              if(int(IC_EE_1[find_EE1][2])==1): 
                 cal_EEpMap1.SetBinContent(int(IC_EE_1[find_EE1][0]), int(IC_EE_1[find_EE1][1]), 1.)
                 cal_EEpMap2.SetBinContent(int(IC_EE_2[find_EE2][0]), int(IC_EE_2[find_EE2][1]), 1.)
              if(int(IC_EE_1[find_EE1][2])==-1):
                 cal_EEmMap1.SetBinContent(int(IC_EE_1[find_EE1][0]), int(IC_EE_1[find_EE1][1]), 1.)
                 cal_EEmMap2.SetBinContent(int(IC_EE_2[find_EE2][0]), int(IC_EE_2[find_EE2][1]), 1.)
