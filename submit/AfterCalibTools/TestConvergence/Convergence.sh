...
dirName="AlCaP0_Run2017_F_CCiter0"                            # dirname (see CalibCode/submit/parameters.py)  
...
extensionDirName="AlCaP0_Run2017_DE_run304366_ContCorrEoverEtrueScaledToV2MC_ext1_fromIter6"
