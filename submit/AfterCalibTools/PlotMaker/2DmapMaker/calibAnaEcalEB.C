...
void calibAnaEcalEB::setHistograms() {
  ...
  if (Pi0orEta == "Pi0") {
    if (this->getIterNumber() == "iter_0" && this->getDirName().find("_ext") == string::npos) th2dMinZaxisVector.push_back(0.120);
...
void calibAnaEcalEB::set2DmapMaxZaxisVector() {
  ...
  if (Pi0orEta == "Pi0") {
    if (this->getIterNumber() == "iter_0" && this->getDirName().find("_ext") == string::npos) th2dMaxZaxisVector.push_back(0.130);
...
{  
  ...
  if (Pi0orEta == "Pi0") {
    if (this->getIterNumber() == "iter_0" && this->getDirName().find("_ext") == string::npos) mean_iphiProfile->GetYaxis()->SetRangeUser(0.12,0.13);
