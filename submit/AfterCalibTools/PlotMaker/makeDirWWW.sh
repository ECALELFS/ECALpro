...
baseDir="AlCaP0_Run2018A"       # dirname (could use any name, but better to stick with dirname in parameters.py
iter_ini=5 # first iteration to use (in general it would be 0)                                               
iter_fin=5  # last iteration to use: it is included in sequence below (if you did n iterations, this should be n-1)                  
