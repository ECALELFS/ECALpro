...
void drawEoverEtrueMaps(const string& outDir = "/afs/cern.ch/user/m/mciprian/www/pi0calib/CC_EoverEtrue_2018/pi0CC_2018_EoverEtrue_foldSM_nFit10_onlyEB_test/",
			const string& inputFile = "root://eoscms//eos/cms/store/group/dpg_ecal/alca_ecalcalib/piZero_Run2/mciprian/pi0CC_2018_EoverEtrue_foldSM_nFit10_onlyEB_test/iter_0/pi0CC_2018_EoverEtrue_foldSM_nFit10_onlyEB_test_calibMap.root",
			const Double_t mapMin = 1.0,
			const Double_t mapMax = 1.12) 
{
