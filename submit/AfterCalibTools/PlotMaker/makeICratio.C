...
void makeICratio(//const string& outDir = "/afs/cern.ch/user/m/mciprian/www/pi0calib/ICplot/AlCaP0_Run2017_F_CCiter0/iter_6/2DMaps/ratio/",
		 const string& outDir = "/afs/cern.ch/user/m/mciprian/www/pi0calib/ICplot/ratioIC/AlCaP0_Run2018D_goldenJson_13_09_2018_iter6__Over__AlCaP0_Run2018A_iter6/",
		 const string& canvasSuffix = "ratioIC",
		 const string& inputFile1 = "/afs/cern.ch/user/m/mciprian/www/pi0calib/ICplot/AlCaP0_Run2018D_goldenJson_13_09_2018/iter_6/2DMaps/ICmaps/IC_work/calibMap_EB_divided_foldSMafterNorm1eachModulePlusMinusSeparate_norm1etaRing.root",
